/*
  ...
  - You are about to alter the column `fullyDilutedValuation` on the `MarketData` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Float`.
  - You are about to alter the column `marketCap` on the `MarketData` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Float`.
  - You are about to alter the column `totalVolume` on the `MarketData` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Float`.
...
CREATE TABLE "new_MarketData" (
    ...
    "fullyDilutedValuation" REAL NOT NULL,
